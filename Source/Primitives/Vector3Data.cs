...
{
    /// <summary>
    /// Engine-agnostic, serializable three-component vector.
    /// Implements <see cref="IVector3"/> so its components can be consumed without a Unity dependency.
    /// </summary>
    [DataContract]
    public struct Vector3Data : IVector3
    {
        ...
        /// <summary>
        /// Initializes a new <see cref="Vector3Data"/> with the specified components.
        /// </summary>
